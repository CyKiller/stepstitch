...
// "Live" only appears when the hosted console actually answers; when the proxy is not
// wired, nothing on this page (metadata included) may claim it is live.
export const metadata: Metadata = demoOnline
  ? {
      title: "Try the StepStitch console - live synthetic demo, no signup",
      description:
  ...
  : {
      title: "StepStitch console preview",
      description:
        "See the operator console StepStitch ships. The hosted demo is offline; one command runs the same console locally over the same synthetic data.",
    };
  ...
  return (
    <main id="main" className="flex-1">
      <Section className="pt-12">
        ...
        <div className="mt-6">
          <SectionHeader
            eyebrow={demoOnline ? "Live synthetic console" : "Console preview"}
            ...
            body={
              demoOnline
                ...
                : "This is the operator console StepStitch actually ships. The hosted demo is not running at the moment, but one command brings the same console up locally over the same synthetic dataset built by the real pipeline. No signup, no credentials, read-only."
            }
          />
        </div>
