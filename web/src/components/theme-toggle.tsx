...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="grid size-11 place-items-center rounded-full border border-line text-muted transition-colors hover:text-fg hover:border-fg/30 active:scale-[0.97]"
    >
      {theme === "dark" ? (
