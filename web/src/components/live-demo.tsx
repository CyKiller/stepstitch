    ...
    <div className="overflow-hidden">
      ...
      {trace ? (
        <p className="border-b border-line bg-surface-2/40 px-4 py-2 text-[12px] leading-relaxed text-muted sm:px-5">
          {trace.source === "live"
            ? "Fetched just now from a running StepStitch service — a real trace, scrubbed server-side before it ever reached this page."
            : "Bundled synthetic sample, generated by the production pipeline — shown because a live service is not connected right now."}
        </p>
      ) : null}
