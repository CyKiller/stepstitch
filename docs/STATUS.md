...
| Suite | Tests | Command |
|---|---|---|
| Service (compiler, router, privacy, connectors) | **608** | `PYTHONPATH=service pytest service/tests/` |
| Host (auth, dashboard, real Postgres) | **203** (1 skipped) | `PYTHONPATH=service pytest server/tests/` |
