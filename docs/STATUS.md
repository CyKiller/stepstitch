...
**Current release: 0.9.1** <!-- x-release-please-version --> — published to npm, PyPI and
...
| Suite | Tests | Command |
|---|---|---|
| Service (compiler, router, privacy, connectors) | **583** | `PYTHONPATH=service pytest service/tests/` |
| Host (auth, dashboard, real Postgres) | **199** (1 skipped) | `PYTHONPATH=service pytest server/tests/` |
