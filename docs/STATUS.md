...
**Current release: 0.10.0** <!-- x-release-please-version --> — published to npm, PyPI and
...
| Suite | Tests | Command |
|---|---|---|
| Service (compiler, router, privacy, connectors) | **619** | `PYTHONPATH=service pytest service/tests/` |
