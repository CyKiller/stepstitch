...
| Suite | Tests | Command |
|---|---|---|
| Service (compiler, router, privacy, connectors) | **588** | `PYTHONPATH=service pytest service/tests/` |
| Host (auth, dashboard, real Postgres) | **200** (1 skipped) | `PYTHONPATH=service pytest server/tests/` |
