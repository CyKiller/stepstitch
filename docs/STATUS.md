...
| Suite | Tests | Command |
|---|---|---|
| Service (compiler, router, privacy, connectors) | **324** | `PYTHONPATH=service pytest service/tests/` |
...
| Overview dashboard — metrics, charts, glyph constellation | `metrics.py` + `server/dashboard.py` | `test_metrics.py`, `test_dashboard_charts.py` |
